...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"站站查询","留言信息","新闻公告","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, StationToStationListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, GuestBookListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, NewsInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
