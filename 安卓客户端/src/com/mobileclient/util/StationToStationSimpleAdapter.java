...
public class StationToStationSimpleAdapter extends SimpleAdapter { 
	/*需要绑定的控件资源id*/
    private int[] mTo;
    /*map集合关键字数组*/
...
/*需要绑定的数据*/
    ...
    public StationToStationSimpleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to,ListView listView) { 
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  if (convertView == null) convertView = mInflater.inflate(R.layout.stationtostation_list_item, null);
	  ...
	  holder.tv_startStation.setText("起始站：" + (new BusStationService()).GetBusStation(Integer.parseInt(mData.get(position).get("startStation").toString())).getStationName());
